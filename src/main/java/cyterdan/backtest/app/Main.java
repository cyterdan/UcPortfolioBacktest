    ...
    public static void main(String[] args) throws SQLException {
        ...
        On.post("/backtest").json((Req req) -> {
            ...
            if (!validatePortfolio(porte)) {
                ...
                Map<String, SortedMap<LocalDate, Double>> data = Data.getDataForIsins(isinSet);
                ...
                SortedMap<LocalDate, Double> referenceData = Data.getDataForIsins(referenceIsin).get(refIsin);
                ...
                //async log
                Jobs.schedule(() -> Data.logBacktest(permalink, formattedPerf, formattedStd), 1, TimeUnit.NANOSECONDS);
